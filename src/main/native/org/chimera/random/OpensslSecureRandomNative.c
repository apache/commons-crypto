...
JNIEXPORT void JNICALL Java_org_chimera_random_OpensslSecureRandomNative_initSR
...
JNIEXPORT jboolean JNICALL Java_org_chimera_random_OpensslSecureRandomNative_nextRandBytes___3B
