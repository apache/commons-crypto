...
#include "org_apache_chimera_random.h"
...
JNIEXPORT void JNICALL Java_org_apache_chimera_random_OpensslSecureRandomNative_initSR
...
JNIEXPORT jboolean JNICALL Java_org_apache_chimera_random_OpensslSecureRandomNative_nextRandBytes___3B
