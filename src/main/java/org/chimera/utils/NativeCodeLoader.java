...
import org.chimera.ChimeraUtils;
...
public class NativeCodeLoader {
  ...
  static File findNativeLibrary() {
    ...
    chimeraNativeLibraryPath = "/org/chimera/native/"
  ...
  public static String getVersion() {
    URL versionFile = NativeCodeLoader.class
        .getResource("/META-INF/maven/org.chimera/chimera/pom.properties");
    if (versionFile == null)
      versionFile = NativeCodeLoader.class
          .getResource("/org/chimera/VERSION");
