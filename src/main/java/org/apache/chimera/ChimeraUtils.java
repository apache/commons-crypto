...
import static org.apache.chimera.ConfigurationKeys.CHIMERA_LIB_NAME_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_LIB_PATH_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_TEMPDIR_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_CRYPTO_BUFFER_SIZE_DEFAULT;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_CRYPTO_BUFFER_SIZE_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_SYSTEM_PROPERTIES_FILE;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_CRYPTO_CIPHER_SUITE_DEFAULT;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_CRYPTO_CIPHER_SUITE_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_CRYPTO_CODEC_CLASSES_KEY_PREFIX;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_CRYPTO_JCE_PROVIDER_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_JAVA_SECURE_RANDOM_ALGORITHM_DEFAULT;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_JAVA_SECURE_RANDOM_ALGORITHM_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_RANDOM_DEVICE_FILE_PATH_DEFAULT;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_RANDOM_DEVICE_FILE_PATH_KEY;
import static org.apache.chimera.ConfigurationKeys.CHIMERA_SECURE_RANDOM_IMPL_KEY;
...
import org.apache.chimera.random.OsSecureRandom;
import org.apache.chimera.utils.ReflectionUtils;
  ...
  private static void loadSnappySystemProperties() {
    try {
      ...
      while (names.hasMoreElements()) {
        ...
        if (name.startsWith("org.apache.chimera.")) {
