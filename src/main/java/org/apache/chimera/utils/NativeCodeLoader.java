 ...
 */
package org.apache.chimera.utils;
...
import org.apache.chimera.ChimeraUtils;
...
public class NativeCodeLoader {
  ...
  static File findNativeLibrary() {
    ...
    chimeraNativeLibraryPath = "/org/apache/chimera/native/"
  ...
  public static String getVersion() {
    URL versionFile = NativeCodeLoader.class
        .getResource("/META-INF/maven/org.apache.chimera/chimera/pom.properties");
    if (versionFile == null)
      versionFile = NativeCodeLoader.class
          .getResource("/org/apache/chimera/VERSION");
